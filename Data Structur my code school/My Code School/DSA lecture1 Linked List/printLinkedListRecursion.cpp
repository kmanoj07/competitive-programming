...
void printRecursive(Node* head){
    ...
    cout << head->data << " ";//first print the head node data
    printRecursive(head->next);//call the same function pass the next node addess
}
...
void reverseListRecurssion(Node* head){
    if(head == NULL){
        return;
    }
    reverseListRecurssion(head->next);
    //link change
